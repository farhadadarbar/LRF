          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="row mb-3">
                ...
                <div class="col-6 text-end">
                    ...
                    @csrf
                    <!-- Form fields go here -->
                  <button class="btn btn-outline-primary btn-sm mb-0">تازه</button>
                </form>

                 
                </div>
                  <p class="text-sm" style='padding: 10px;'>
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">{{$itemcont}}</span>عدد
                  </p>
                </div>
                <div class="col-6 my-auto text-start">
                  <div class="dropdown float-start ps-4">
                    ...
                    <ul class="dropdown-menu  px-2 py-3 me-n4" aria-labelledby="dropdownTable">
                      <li><a class="dropdown-item border-radius-md" href="javascript:;">حذف همه</a></li>
                      <li><a class="dropdown-item border-radius-md" href="javascript:;"> آخر</a></li>
            ...
            <div class="card-body p-0 pb-2">
                    ...
                    <div class="gallery">
                        ...
                        <img src="{{ asset('public/uploads/1/EMULATOR32X1X14X0/' . $image->filename) }}" alt="Forest" width="600" height="400">
                        </a>
